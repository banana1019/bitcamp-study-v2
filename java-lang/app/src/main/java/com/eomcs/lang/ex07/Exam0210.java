...
//
// 1) 명령어 블록을 실행할 때 값을 넘겨주지 않고 결과도 리턴하지 않는다.
// void 메서드명() {
//   문장1;
//   문장2;
// }
//
// 2) 명령어 블록을 실행할 때 작업에 필요한 값을 넘겨준다. 그러나 결과는 리턴하지 않는다.
// void 메서드명(변수선언1, 변수선언2, ...) {
//   문장1;
//   문장2;
// }
//
// 3) 명령어 블록을 실행할 때 값을 받지 않는다. 작업 결과는 리턴한다.
// 리턴타입 메서드명() {
//   문장1;
//   문장2;
// }
//
// 4) 명령어 블록을 실행할 때 작업에 필요한 값을 넘겨주고 결과를 받는다.
