...
public class Exam01 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //
    URL url = new URL("https://search.naver.com:443/search.naver?sm=top_hty&fbm=1&ie=utf8&query=bitcamp");
    // http://www.auction.co.kr:80/  포트번호 생략 가능
    // https://www.naver.com:443/    포트번호 생략 가능
