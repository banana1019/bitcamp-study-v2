...
CREATE TABLE lms_lecture (
  Ino        INTEGER      NOT NULL COMMENT '강의번호', -- 강의번호
  ...
  total_hour INTEGER      NOT NULL DEFAULT 0 COMMENT '총수업시간', -- 총수업시간
  day_hour   INTEGER      NULL     COMMENT '일수업시간', -- 일수업시간
...
ALTER TABLE lms_lecture
  MODIFY COLUMN Ino INTEGER NOT NULL AUTO_INCREMENT COMMENT '강의번호';
...
CREATE TABLE lms_classroom (
  ...
  cmtno INTEGER     NOT NULL COMMENT '교육센터번호', -- 교육센터번호
...
ALTER TABLE lms_center
  MODIFY COLUMN cmtno INTEGER NOT NULL AUTO_INCREMENT COMMENT '교육센터번호';
...
CREATE TABLE lms_grade (
  gno  INTEGER     NOT NULL COMMENT '학력번호', -- 학력번호
  type VARCHAR(20) NOT NULL COMMENT '학력명' -- 학력명
)
COMMENT '학력';
...
CREATE TABLE lms_work_type (
  wtno  INTEGER     NOT NULL COMMENT '고용형태번호', -- 고용형태번호
  title VARCHAR(20) NULL     COMMENT '고용형태명' -- 고용형태명
)
COMMENT '고용형태';
...
CREATE TABLE lms_classroom_photo (
  COL      INTEGER      NOT NULL COMMENT '강의실사진번호', -- 강의실사진번호
  crno     INTEGER      NOT NULL COMMENT '강의실번호', -- 강의실번호
...
ALTER TABLE lms_classroom_photo
  MODIFY COLUMN COL INTEGER NOT NULL AUTO_INCREMENT COMMENT '강의실사진번호';

-- 주소
CREATE TABLE lms_addr (
  ano      INTEGER      NOT NULL COMMENT '주소번호', -- 주소번호
  pstno    VARCHAR(10)  NULL     COMMENT '우편번호', -- 우편번호
